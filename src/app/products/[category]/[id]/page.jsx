    ...
    <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative flex flex-col lg:flex-row gap-16">
      ...
      <div className="flex flex-col gap-6">
        ...
        <h1 className="text-2xl font-semibold">
          Miraya Modern 2pc Book End Polyresin Hand Finished Terracotta 26cm by Living Essence
        </h1>
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">
            (Inclusive of all prices). Tax included. <span className="underline cursor-pointer">Shipping</span> calculated at checkout.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center border rounded-md">
            <button onClick={decreaseQty} className="px-3 py-1 border-r hover:bg-gray-100">-</button>
            <span className="px-4">{quantity}</span>
            <button onClick={increaseQty} className="px-3 py-1 border-l hover:bg-gray-100">+</button>
          </div>
