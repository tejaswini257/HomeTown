        ...
        <div className="mt-16">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <p className="text-gray-600 leading-relaxed">
              {product.description} This premium product is crafted with attention to detail and designed to enhance your living space. 
              Made from high-quality materials, it offers both style and functionality. Perfect for modern homes, this piece combines 
              contemporary design with practical features that make it a great addition to any room.
            </p>
          </div>
        </div>
      </div>
